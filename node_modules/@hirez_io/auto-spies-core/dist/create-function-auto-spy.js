...
function createFunctionAutoSpy(functionName, addFrameworkMethodsToCalledWithObject, frameworkFunctionSpyFactory) {
    ...
    _1.addObservableHelpersToFunctionSpy(objectToAddSpyMethodsTo, valueContainer);
...
function addMethodsToCalledWith(calledWith, calledWithArgs, addFrameworkMethodsToCalledWithObject) {
    ...
    calledWith = _1.addPromiseHelpersToCalledWithObject(calledWith, calledWithArgs);
    calledWith = _1.addObservableHelpersToCalledWithObject(calledWith, calledWithArgs);
    return calledWith;
}
